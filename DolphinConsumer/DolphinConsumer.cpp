...
DolphinConsumer::DolphinConsumer(uint32_t n, uint32_t r, size_t b): node_id(n), remote_id(r), buffer_size(b) {
...
const void *DolphinConsumer::getResource() {
    sci_error_t error;
